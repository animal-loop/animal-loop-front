import {
 ...
 function fetchApiSuccess(data) {
 	return {
 		type: FETCH_DETAIL_FULFILLMENT_SUCCESS,
 		payload: data,
 	};
 }
 ...
 function fetchApiFailure(error) {
 	console.log(error)
 	return {
 		type: FETCH_DETAIL_FULFILLMENT_FAILURE,
 		payload: error,
 	};
 }
 ...
 function fetchApiInit() {
 	return {
 		type: FETCH_DETAIL_FULFILLMENT_INIT,
 	};
 }

 export function fetchDetailFulfillmentApi(group,tags) {
